...
function DiscordLib:Window(text,mainclr,cls)
	...
	function ServerHold:Server(text, img)
		...
		local UIRGBs0 = Instance.new("UIGradient")
		local UIRGBs1 = Instance.new("UIGradient")
		local UIRGBs2 = Instance.new("UIGradient")
		local UIRGBs3 = Instance.new("UIGradient")
		local UIRGBs4 = Instance.new("UIGradient")
		local UIRGBs5 = Instance.new("UIGradient")
		local UIRGBs6 = Instance.new("UIGradient")
		local UIRGBs7 = Instance.new("UIGradient")
		local UIRGBs8 = Instance.new("UIGradient")
		...
		UIRGBs0.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 0, 50)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 200))}
    	UIRGBs0.Parent = ServerFrame
		...
		GlowFrame.BackgroundTransparency = 0.999
		...
		ServerContentFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		...
		ChannelTitleFrame.BackgroundColor3 = Color3.fromRGB(10, 0, 0)
		ChannelTitleFrame.BorderSizePixel = 0
		ChannelTitleFrame.Position = UDim2.new(0.294561088, 0, -0.000900391256, 0)
		ChannelTitleFrame.Size = UDim2.new(0, 429, 0, 40)

		UIRGBs5.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 150))}
    	UIRGBs5.Parent = ChannelTitleFrame
		...
		ChannelContentFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
		ChannelContentFrame.BorderSizePixel = 0
		ChannelContentFrame.ClipsDescendants = true
		ChannelContentFrame.Position = UDim2.new(0.294561088, 0, 0.106338218, 0)
		ChannelContentFrame.Size = UDim2.new(0, 429, 0, 333)

		UIRGBs3.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100, 0, 150)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 255))}
    	UIRGBs3.Parent = ChannelContentFrame

		ChannelContentFrameCorner.CornerRadius = UDim.new(0, 5)
		...
		function ChannelHold:Channel(text,ico)
			...
			ChannelBtnOutline.Position = UDim2.new(-0.0, 0, 0.0, 0)
			ChannelBtnOutline.Size = UDim2.new(0, 165, 0, 38)
			ChannelBtnOutline.BackgroundColor3 = Color3.fromRGB(255, 0, 0)

			ChannelBtnOutlineCorner.CornerRadius = UDim.new(0, 5)
			...
			ChannelBtn.Position = UDim2.new(0.002118, 0, 0.0, 0)
			ChannelBtn.Size = UDim2.new(0, 164.0, 0, 37)
			...
			ChannelBtnCorner.CornerRadius = UDim.new(0, 5)
			...
			ChannelIcon.Position = UDim2.new(0.0234146333, 0, 0.11, 0)
			...
			ChannelHolder.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 0)
			...
			ChannelBtn.MouseEnter:Connect(function()
				if currentchanneltoggled ~= ChannelBtn.Name then
					ChannelBtn.BackgroundColor3 = Color3.fromRGB(100, 0, 100)
					ChannelBtnTitle.TextColor3 = Color3.fromRGB(255, 100, 255)
				end
			end)
			...
			ChannelBtn.MouseEnter:Connect(function()
				if currentchanneltoggled == ChannelBtn.Name then
					ChannelBtn.BackgroundColor3 = Color3.fromRGB(20, 0, 20)
					ChannelBtnTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
				end
			end)
			...
			ChannelBtn.MouseLeave:Connect(function()
				if currentchanneltoggled == ChannelBtn.Name then
					ChannelBtn.BackgroundColor3 = Color3.fromRGB(10, 0, 10)
					ChannelBtnTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
				end
			end)
			...
			ChannelBtn.MouseButton1Click:Connect(function()
				...
				for i, v in next, ServerChannelHolder:GetChildren() do
					if v.ClassName == "TextButton" then
						v.BackgroundColor3 = Color3.fromRGB(100, 0, 100)
...
AutoFarm:Toggle("Toggle")

local GGz = serv:Channel("GG", "http://www.roblox.com/asset/?id=7040391851")
